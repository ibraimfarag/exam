...
<head>
    ...
    <link href="{{ asset('template/backend/sb-admin-2') }}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/backend/jodit-3.24.5/build/jodit.min.css') }}" />
    <link
...
<body id="page-top">
    ...
    <script src="{{ asset('assets/backend/jodit-3.24.5/build/jodit.min.js') }}"></script>
    @stack('js')
    <script>
        const editor = Jodit.make('#intro_text ');
        const editor2 = Jodit.make('#properties_description');
    </script>
    <script></script>
